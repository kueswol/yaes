...
impl Brain {
    ...
    ///  16-23 value2,
    ///  24-31 value3,
    ///  32-48 fired_neurons_count
    pub fn tick(&self, input: u64) -> u64 {
        const DEBUG_OUTPUT: bool = false;
        let mut fired_count: u16 = 0;
        ...
        output_bits |= (fired_count as u64) << 32; // add fired neurons count to the output (in the most significant bits)
